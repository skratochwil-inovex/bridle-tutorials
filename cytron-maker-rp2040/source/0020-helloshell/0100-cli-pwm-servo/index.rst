...
der PWM Kanäle im RP2040 bezogen auf die Servo Motoren:
...
Die Servomotoren sind also an **GP12** bis **GP15** angeschlossen, an den
zugehörigen **PWM Kanälen 12 bis 15**:
...
**Wie gelingt es nun, mit einer PWM einen Servomotor zu bewegen?**

Ähnlich wie in der :ref:`vorherigen Übung <hs-cli-pwm-led>` zur LED Helligkeit
werden Servomotoren mit einer definierten **Impulsdauer** von **500µs bis
2,5ms** innerhalb einer **festen Periode von 20ms** (Grundfrequenz *fₚ = 50Hz*)
gesteuert. Je nach Typ wird damit durch den Servomotor selbständig eine fest
definierte Winkelposition oder eine Drehgeschwindigkeit mit (CW) oder gegen
(CCW) den Uhrzeigersinn geregelt.

Du hast an deinem MCU-Board je 2 Servomotoren beider Typen angeschlossen. Die
folgenden beiden Impulsdiagramme stellen die Details dar.
